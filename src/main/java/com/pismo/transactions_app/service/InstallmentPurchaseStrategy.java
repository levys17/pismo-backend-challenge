...
@Component
public class InstallmentPurchaseStrategy implements IOperationStrategy {

    private static final Logger log = LoggerFactory.getLogger(InstallmentPurchaseStrategy.class);
    ...
    public OperationTypeEnum getOperationType() {
        return OperationTypeEnum.INSTALLMENT_PURCHASE;
    }
}
