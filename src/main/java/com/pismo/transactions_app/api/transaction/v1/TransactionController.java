...
public class TransactionController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<TransactionResponseDto> getById(@PathVariable(value = "id") final Long id) {
        final TransactionResponseDto response = transactionService.getById(id);
